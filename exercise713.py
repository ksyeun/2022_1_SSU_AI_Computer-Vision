...
blur_1_cv2blur = cv2.blur(image, (5, 5), borderType=cv2.BORDER_CONSTANT)  
blur_2_cv2box = cv2.boxFilter(image, ddepth=-1, ksize=(5, 5))   
blur_3_avg  = average_filter(image, 5)   

cv2.imshow("image", image)
cv2.imshow("blur_1", blur_1_cv2blur)
cv2.imshow("blur_2", blur_2_cv2box)
cv2.imshow("blur_3", blur_3_avg)
cv2.waitKey(0)
